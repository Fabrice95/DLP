...
// fonction
fonctions returns [com.paracamplus.ilp1.ilp1tme2.ex1.interfaces.IASTfunction node]
    : 'function' nom=IDENT '(' (pars+=expr ( ',' pars+=expr)*)?')' body+=expr (body+=expr)* #Definefunction
    ;
...
// boucle
    | 'while' condition=expr 'do' body=expr # While
    ;
